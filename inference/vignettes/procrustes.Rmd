...
write_csv(edge_dists, file.path(data_dir, sprintf("edge_dists_%s.csv", params$model_prefix)))
```
...
write_csv(cca_data, file.path(data_dir, sprintf("cca_data_%s.csv", params$model_prefix)))
```
...
write_csv(selections, file.path(data_dir, sprintf("selections_%s.csv", params$model_prefix)))
```
```{r remove_unzipped}
