...
#for (perc in c("15", "50", "90")) {
  ...
  #        train_perc == perc,
    ...
    ggsave(
      sprintf("~/Desktop/conceptual/learned_inference/notes/figure/tnbc_imagegrid-%s-1-2.png", dimred),
...
ggplot(edge_data_) +
  ...
  facet_wrap(sca ~ method, scale = "free") +
...
ggsave("~/Desktop/conceptual/learned_inference/notes/figure/tnbc_embeddings-1-2.png", dpi = 500)
```
...
ggsave("~/Desktop/conceptual/learned_inference/notes/figure/tnbc_embeddings-full-both-1-2.png", dpi = 500)
```
