...
source("../R/mibi.R")
extract_patches(tiff_paths[params$j], exper, response = "PD1", out_dir = file.path(params$data_dir, "tiles"), qsize = params$qsize, basename = sprintf("patch_%s", params$j))
y_data <- read_csv(file.path(params$data_dir, "tiles", "y.csv"))
```
