...
paths_df <- data.frame(
  subset = c("data/simulation_outputs/model_features/cnn/features/subset.csv", "data/simulation_outputs/model_features/vae/features/subset.csv", "data/simulation_outputs/model_features/rcf/features/subset.csv"),
  feature = c("data/simulation_outputs/model_features/cnn/features/linear_best.npy", "data/simulation_outputs/model_features/vae/features/mu_best.npy", "data/simulation_outputs/model_features/rcf/features/full_best.npy")
)
```
