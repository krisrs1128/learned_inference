...
paths_df <- data.frame(
  subset = c("b0/cnn90/features/subset.csv", "b1/cnn90/features/subset.csv", "b0/rcf90/features/subset.csv", "b1/rcf90/features/subset.csv"),
  feature = c("b0/cnn90/features/linear_best.npy", "b1/cnn90/features/linear_best.npy", "b0/rcf90/features/full_best.npy", "b1/rcf90/features/full_best.npy")
)
```
